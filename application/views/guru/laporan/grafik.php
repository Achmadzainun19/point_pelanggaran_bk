            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div  class="col-sm-12" style="padding-bottom:20px;">
                        ...
                        <a href="<?php echo base_url();?>laporan_guru/grafik" class="btn btn-warning">grafik pelanggaran</a>
        ...
        <div class="modal" id="search">
            <div class="modal-dialog">
                ...
                <form action="<?php echo base_url();?>laporan_guru/cari_grafik" method="post">
                <!-- Modal body -->
